...
- 이 프로젝트는 "우테코 식당"의 크리스마스 시즌을 맞아 고객들에게 특별한 경험을 제공하기 위한 프로모션을 구현했습니다.
- 다양한 할인 이벤트와 증정 혜택을 통해 고객에게 즐거움을 드리고, 동시에 식당의 연말 매출 향상을 기대 합니다.
- 이 프로모션은 고객이 주문한 메뉴와 수량에 따랏 할인 및 증정 혜택을 계산하고 특별한 이벤트 배지를 제공하여 고객의 참여를 유도합니다.
- 고객이 선택한 메뉴와 방문 날짜에 따라 다양한 할인 옵션이 제공됩니다.
- 주문한 시점에서 총 할인액과 최종 결제 금액을 바로 계산하여 안내합니다.

**프로모션은 2023년 12월동안 우테코 식장에서 10,000원 이상 결제한 모든 고객에게 적용됩니다.**
